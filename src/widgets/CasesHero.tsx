...
const logos = [
  {
    src: '/89089deca955dc49d09235720b360de79afe0d79.svg',
    alt: 'Elite Logo',
  },
  {
    src: '/042e7de978cfcd8b73ef5a2fee6b7530147ec2cd.svg',
    alt: '439 Logo',
  },
  {
    src: '/79fd724126a35511e13fa23df508c0a796869d07.svg',
    alt: '3 Logo',
  },
  {
  ...
  {
    src: '/c2c253130e5600a2f8c7b8d7f22c4d7596bf3b59.svg',
    alt: 'Screenshot 4',
  },
  {
  ...
  return (
    <div className="bg-white-pure relative w-full h-[968px] overflow-hidden">
      ...
      <div className="absolute h-[968px] left-1/2 overflow-hidden -top-[78px] -translate-x-1/2 w-[1980px] max-w-none">
        ...
        {/* Основной контент */}
        <div className="flex flex-col gap-10 h-[690px] items-start container pt-56" style={{ top: "calc(50% + 39px)", left: "calc(50% + 0.5px)" }}>
          {/* Заголовок */}
